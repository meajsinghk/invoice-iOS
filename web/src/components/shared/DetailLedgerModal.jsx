    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ fontWeight: 700, color: 'white', fontSize: 17 }}>Ledger</span>
        </div>
        ...
        <div style={{ padding: '20px 20px 100px', display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div>
            <div style={{ fontWeight: 700, fontSize: 14, color: 'rgba(255,255,255,0.5)', marginBottom: 10, textTransform: 'uppercase', letterSpacing: 1 }}>
              Transactions
            </div>
            {entries.length === 0 ? (
